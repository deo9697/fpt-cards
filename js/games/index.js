...
import { searchCards as searchOnePieceCards, findCard as findOnePieceCard, findCardById as findOnePieceCardById, cardCostsByIds as onePieceCardCostsByIds } from './onepiece/catalog.js';
...
const ADAPTERS = {
  ...
  onepiece: {
    ...
    cardCostsByIds: onePieceCardCostsByIds,
