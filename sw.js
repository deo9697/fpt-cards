...
const MEDIA_FILES = ['./assets/fpt-card-hero.png', './assets/market-watch-dan.jpg', './assets/notification-badge.png', './assets/deck-boxes/arcane-vault.png', './assets/deck-boxes/infernal-dragon.png', './assets/deck-boxes/cyber-core.png', './assets/avatars/avatar-tonno.jpg', './assets/fonts/cinzel-latin-variable.woff2', './assets/fonts/manrope-latin-variable.woff2', './assets/ester-eggs/videoplayback.mp4', './assets/ester-eggs/skelet_roar.mp4', './assets/ester-eggs/Cat%20Laughing%20At%20You.mp4'];
