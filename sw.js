const CACHE = 'fpt-cards-v27';
const FILES = ['./', './index.html', './styles.css', './app.js', './js/core.js', './js/api.js', './js/cards.js', './js/icons.js', './js/dashboard.js', './js/push.js', './js/easter-egg.js', './assets/HEYYEYAAEYAAAEYAEYAA.mp3', './config.js', './icon.svg', './manifest.webmanifest'];
