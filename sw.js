const CACHE = 'fpt-cards-v31';
const FILES = ['./', './index.html', './styles.css', './app.js', './js/core.js', './js/api.js', './js/cards.js', './js/icons.js', './js/dashboard.js', './js/push.js', './js/easter-egg.js', './js/pwa-update.js', './js/install.js', './assets/HEYYEYAAEYAAAEYAEYAA.mp3', './config.js', './icon.svg', './manifest.webmanifest'];
