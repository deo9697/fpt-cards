...
const FILES = ['./', './index.html', './styles.css', './app.js', './js/app-launch.js', './js/core.js', './js/api.js', './js/pagination.js', './js/cards.js', './js/games/index.js', './js/games/yugioh/catalog.js', './js/games/yugioh/rules.js', './js/games/onepiece/catalog.js', './js/games/onepiece/rules.js', './js/games/onepiece/collection.js', './js/catalog-verification.js', './js/icons.js', './js/dashboard.js', './js/team.js', './js/collection.js', './js/collection-search.js', './js/collection-name-aliases.js', './js/collection-share.js', './js/decks.js', './js/deck-box.js', './js/deck-archetype-unlocks.js', './js/stats.js', './js/progression.js', './js/cosmetics.js', './js/missions.js', './js/market-watch.js', './js/fast-scan.js', './js/fast-scan-core.js', './js/fast-scan-camera.js', './js/fast-scan-ocr-engine-b.js', './js/fast-scan-catalog-cache.js', './js/fast-scan-storage.js', './js/fast-scan-sync.js', './js/push.js', './js/easter-egg.js', './js/pwa-update.js', './js/connectivity.js', './config.js', './icon-192.png', './icon-512.png', './icon-512-maskable.png', './manifest.webmanifest'];
const MEDIA_FILES = ['./assets/game-logos/yugioh-tcg.png', './assets/fpt-card-hero.png', './assets/background/yugioh-01.png', './assets/market-watch-dan.jpg', './assets/notification-badge.png', './assets/deck-boxes/arcane-vault.png', './assets/deck-boxes/infernal-dragon.png', './assets/deck-boxes/cyber-core.png', './assets/deck-boxes/sacred_beast_orcust_deckbox.png', './assets/deck-boxes/mitsurugi_deckbox.png', './assets/deck-boxes/skystriker_deckbox.png', './assets/avatars/avatar-tonno.jpg', './assets/avatars/nellentone.jpeg', './assets/avatars/cristofer.jpeg', './assets/avatars/capeleira.jpeg', './assets/fonts/cinzel-latin-variable.woff2', './assets/fonts/manrope-latin-variable.woff2', './assets/ester-eggs/videoplayback.mp4', './assets/ester-eggs/skelet_roar.mp4', './assets/ester-eggs/Cat%20Laughing%20At%20You.mp4'];
