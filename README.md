...
Il badge dello scatto resta visibile fino al successivo: verde "Carta aggiunta · +1 — avanti", giallo "Codice acquisito — avanti, verifico in background", arancione "Da verificare nella review — avanti", rosso "Codice non letto — riprova questa carta". La verifica dell'ultimo scatto aggiorna il suo badge; se nel frattempo è iniziato un altro scatto, compare un avviso separato con il codice e l'indicazione "Scatto precedente", senza sovrascrivere l'esito corrente. I badge non introducono attese e vengono ricostruiti anche dopo un ridisegno dell'interfaccia.
