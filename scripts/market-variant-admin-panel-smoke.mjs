...
try {
  ...
  console.log('PASS market variant admin panel: rendering, badge status, link Vedi verso Cardmarket in nuova scheda, selezione candidato isolata per card, conferma/filtri/load-more chiamano gli handler con gli argomenti corretti');
} finally {
