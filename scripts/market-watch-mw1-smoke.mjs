...
for(const required of ['provider_rarity_mismatch','needsMappingReview','rarityMismatchNotice','Rarità non corrispondente su Cardmarket','AMBIGUOUS','mappingIssueNotice'])assert(frontendSource.includes(required),`Conferma manuale su rarità non corrispondente/AMBIGUOUS incompleta: ${required}`);
