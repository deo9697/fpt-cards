...
assert.equal(buildMarketDecks([{id:'aggregate-deck',name:'Aggregate',cards:[{printingId:'aggregate',quantity:1}]}],[aggregateItem],[])[0].marketValue,null,'prezzo aggregate incluso nel valore mazzo');
